...
import 'mock_types.dart' show Color, Paint, Rect, Path, TextDirection, PaintingStyle, lerpDouble;
...
class BorderSide with Diagnosticable {
  ...
  static BorderSide lerp(BorderSide a, BorderSide b, double t) {
    ...
    final double width = _lerpDouble(a.width, b.width, t)!;
    if (width < 0.0) {
      return BorderSide.none;
    }
...
class StadiumBorder extends OutlinedBorder {
  const StadiumBorder({BorderSide side = BorderSide.none}) : super(side: side);
...
class RoundedRectangleBorder extends ShapeBorder {
  const RoundedRectangleBorder({this.borderRadius = BorderRadius.zero, this.side = BorderSide.none});
