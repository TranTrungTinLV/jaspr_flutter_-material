...
class ChipTheme extends InheritedTheme {
  ...
  static ChipThemeData of(BuildContext context) {
    final ChipTheme? inheritedTheme = context.dependOnInheritedComponentOfExactType<ChipTheme>();
...
class ChipThemeData with Diagnosticable {
  ...
  static BorderSide? _lerpSides(BorderSide? a, BorderSide? b, double t) {
    ...
    if (a is WidgetStateBorderSide) {
      a = (a as WidgetStateBorderSide).resolve(const <WidgetState>{});
    }
    if (b is WidgetStateBorderSide) {
      b = (b as WidgetStateBorderSide).resolve(const <WidgetState>{});
    }
