...
import 'mock_types.dart' show SystemColor, SystemColorPalette, lerpDouble;
import 'package:my_website_flutter/shared/components/painting.dart';
  ...
  ThemeData _overrideWithSystemColors() {
    ...
    theme = theme.copyWith(
      colorScheme: colorScheme.copyWith(
        secondary: systemColors.accentColor,
        onSecondary: systemColors.accentColorText,
        surface: systemColors.canvas,
        onSurface: systemColors.canvasText,
      ),
      textTheme: textTheme.apply(
        displayColor: systemColors.canvasText,
        bodyColor: systemColors.canvasText,
      ),
    );

    final bool overrideButtons =
        systemColors.buttonFace != null ||
        systemColors.buttonBorder != null ||
        systemColors.buttonText != null;

    if (overrideButtons) {
      theme = theme.copyWith(
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            foregroundColor: systemColors.buttonText,
            backgroundColor: systemColors.buttonFace,
            side: systemColors.buttonBorder == null
                ? null
                : BorderSide(color: systemColors.buttonBorder!),
          ),
        ),
    ...
    final bool overrideInputDecoration =
        systemColors.field != null || systemColors.fieldText != null;

    if (overrideInputDecoration) {
      theme = theme.copyWith(
        inputDecorationTheme: inputDecorationTheme.copyWith(
          fillColor: systemColors.field,
          labelStyle:
              inputDecorationTheme.labelStyle?.copyWith(color: systemColors.fieldText) ??
              TextStyle(color: systemColors.fieldText),
          hintStyle:
              inputDecorationTheme.hintStyle?.copyWith(color: systemColors.fieldText) ??
              TextStyle(color: systemColors.fieldText),
          helperStyle:
              inputDecorationTheme.helperStyle?.copyWith(color: systemColors.fieldText) ??
              TextStyle(color: systemColors.fieldText),
          prefixStyle:
              inputDecorationTheme.prefixStyle?.copyWith(color: systemColors.fieldText) ??
              TextStyle(color: systemColors.fieldText),
          suffixStyle:
              inputDecorationTheme.suffixStyle?.copyWith(color: systemColors.fieldText) ??
              TextStyle(color: systemColors.fieldText),
          counterStyle:
              inputDecorationTheme.counterStyle?.copyWith(color: systemColors.fieldText) ??
              TextStyle(color: systemColors.fieldText),
        ),
      );
    }
...
class MaterialBasedCupertinoThemeData extends CupertinoThemeData {
  ...
  CupertinoTextThemeData get textTheme {
    return _cupertinoOverrideTheme.textTheme ?? const CupertinoTextThemeData();
  }
  ...
  CupertinoThemeData resolveFrom(BuildContext context) {
    ...
    final NoDefaultCupertinoThemeData cupertinoOverrideThemeWithTextTheme = _cupertinoOverrideTheme
        .copyWith(textTheme: this.textTheme);
    return MaterialBasedCupertinoThemeData._(
      _materialTheme,
